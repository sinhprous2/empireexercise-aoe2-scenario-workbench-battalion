# Verification plan — Age of Empires II: Definitive Edition

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Local economy exercises

- [ ] Define a versioned input fixture specifically for local economy exercises.
...
### 2. Army matchup worksheets

- [ ] Define a versioned input fixture specifically for army matchup worksheets.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Scenario version notes

- [ ] Define a versioned input fixture specifically for scenario version notes.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
