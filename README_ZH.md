...
<!-- readme-locale:zh -->
<div align="center">
<img src="./public/logo.svg" alt="EmpireExercise — Age of Empires II: Definitive Edition — Battalion" width="64" height="64">
<h1>EmpireExercise — Age of Empires II: Definitive Edition — Battalion</h1>
</div>

独立的项目设计文档，适用对象： **Age of Empires II: Definitive Edition**。
...
- **本地经济练习** (Local economy exercises) — 规划模块，尚未实现。
- **军队对阵工作表** (Army matchup worksheets) — 规划模块，尚未实现。
- **场景版本说明** (Scenario version notes) — 规划模块，尚未实现。
...
| 字段 | 内容 |
|---|---|
| 适用对象 | Age of Empires II: Definitive Edition |
| 类别 | 本地游戏场景规格 |
| 输入 | 手工记录或用户授权的本地导出 |
| 计划输出 | 本地经济练习 |
| 兼容性 | 未验证；未声明支持任何具体版本 |
